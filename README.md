# parma-mining-discord

[![Chore](https://github.com/la-famiglia-jst2324/parma-mining-discord/actions/workflows/chore.yml/badge.svg?branch=main)](https://github.com/la-famiglia-jst2324/parma-mining-discord/actions/workflows/chore.yml)
[![CI](https://github.com/la-famiglia-jst2324/parma-mining-discord/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/la-famiglia-jst2324/parma-mining-discord/actions/workflows/ci.yml)
[![Deploy](https://github.com/la-famiglia-jst2324/parma-mining-discord/actions/workflows/release.yml/badge.svg)](https://github.com/la-famiglia-jst2324/parma-mining-discord/actions/workflows/release.yml)
[![Major Tag](https://github.com/la-famiglia-jst2324/parma-mining-discord/actions/workflows/tag-major.yml/badge.svg)](https://github.com/la-famiglia-jst2324/parma-mining-discord/actions/workflows/tag-major.yml)

ParmaAI mining module for Discord. This module collects data from Discord by using their internal API's and provides these data to Parma Analytics.
...
2. **Clone the repository**
   ...
   ```bash
   git@github.com:la-famiglia-jst2324/parma-mining-discord.git
   ```
...
```bash
.
├── parma_mining.discord: Main sourcing code
...
**Description:**
This endpoint allows clients to search for identifiers based on a query string. It is designed to facilitate the discovery of organizations, domains, channels etc. by keyword. For this module, this endpoint takes name of the company as parameter and returns the server ID of the respective company.
...
Due to Discord's API's limits and security, user has to join the respective servers of the companies that requires to be fetched.
Joining to the servers has to be done manually by the user.

### Discord Auth Token:

This module requires the Discord account's auth token.
To get the Auth Token please refer to [here](https://www.geeksforgeeks.org/how-to-get-discord-token/)
Note: This token should be updated regularly, estimated every month.
